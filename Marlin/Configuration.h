...
//#define BTTE3_TURBO // Choose this if you are using BigTreeTech E3 TURBO board
...
//#define BTTSKR1_4 // Choose this if you are using BigTreeTech SKR 1.4
...
//#define TH3DEZBOARD_LITE //Choose this if you have an original TH3D EZBOARD_LITE
...
/*Board name: 
Board name: Original_creality1, change_value = LPC1769 //use this value in platform.ino. Search for 'change_value' and replace it with this value melzi
...
Board name: Original_creality4, change_value = STM32F103RET6_creality //use this value in platform.ino. Search for 'change_value' and replace it with this value STM32F103RET6_creality
...
-Board name: BTTSKRE3MINIV1_2, change_value = STM32F103RC_btt //use this value in platform.ino. Search for 'change_value' and replace it with this value STM32F103RC_bigtree_512K
-Board name: BTTSKRE3MINIV2_0, change_value = STM32F103RC_btt //use this value in platform.ino. Search for 'change_value' and replace it with this value STM32F103RC_bigtree_512K
-Board name: BTTE3_TURBO, change_value = LPC1769 //use this value in platform.ino. Search for 'change_value' and replace it with this value LPC1769
...
#define e__steps 395.24 //e-steps is defined by the number of revolutions your extruder motor has to turn to define 10mm of filament.
#endif
...
/*** *** ***  Section 11A - Customize your Auto and Manual mesh bed leveling settings here. Otherwise ignore this section *** *** ***/
  ...
  #define GRID_MAX_POINTS_X 6 //Recommended value: 4. If you want to probe a 3x3 grid (9 times), choose 3. Choose 5 if you want to probe a 5x5 grid (25 times)
...
#define PROBING_MARGIN 10 //Change this value to 20 if you have clips holding down your print surface. 10 is a good value if you don't have clips. This is how far you want your BLtouch to probe from the EDGES of the bed
...
/*if have a Custom ABL mount and need to put your own values, please use change_value to define your values below. If not, skip this section and continue below*/
  ...
  #define NOZZLE_TO_PROBE_OFFSET { -39, 0, 0 } //Measure the distance between the centre of your probe to the nozzle and replace 'change_value'. KEEP the value 0 there so you can do your z probe offset calibration. Only replace 0 if you know your values. Otherwise your nozzle may CRASH.
#endif

/*** *** *** Section 13A - Filament Change Settings. This is where you configure your Filament change/ Pause settings *** *** ***/

#define ADVANCED_PAUSE_FEATURE  //Activate this feature if you want to have Filament change and Pause enabled. Mandatory if you activate filament sensor
...
#define Total_filament_path 450 // Please measure the entire distance fron the Extruder to the the tip of the nozzle as accurately as possible. Replace change_value with your measured value here in mm units. NOT ft/inch.
...
#define INVERT_E0_DIR false // true for KAY3D CoreXY Conversion Kits. This is for your Extruder's direction. Change value to false if you need your extruder motor to rotate the other way. ** it's false* *. Not False. Not FALSE. It's case sensitive.
...
//#define FAST_PROBEK // If Enabled, probing speed across mulitple probes will be the same. Only do this if your sensor is accurate from the get go
#define HOMING_MOVEMENT_SPEEDK 4 // Acceptable values are 1 (default), 2, 3, 4, 5 and 6. Please watch out for speeds 5 and 6. These changes your printer's XY homing AND LCD XY manual movement speed.
 ...
 * :[-1, 0, 1, 2, 3, 4, 5, 6, 7]
 */
//#define SERIAL_PORT 0 //value arleady defined elsewhere in  cheetah 5
 ...
 */
//#define TEMP_SENSOR_0 1 //values defined in cheetah 5.0
...
//#define TEMP_SENSOR_BED 0 //values defined in cheetah 5.0
...
//#define USE_XMIN_PLUG //defined elsewhere in cheetah 5.0 sections
//#define USE_YMIN_PLUG //defined elsewhere in cheetah 5.0 sections
//#define USE_ZMIN_PLUG //defined elsewhere in cheetah 5.0 sections
 ...
 */
//#define DEFAULT_ACCELERATION          3000    // values defined elsewhere in cheetah 5. X, Y, Z and E acceleration for printing moves
//#define DEFAULT_RETRACT_ACCELERATION  3000    // values defined elsewhere in cheetah 5.  E acceleration for retracts
//#define DEFAULT_TRAVEL_ACCELERATION   3000    // values defined elsewhere in cheetah 5.  X, Y, Z acceleration for travel (non printing) moves
...
//#define DEFAULT_EJERK    5.0  // Value already defined elsewhere. May be used by Linear Advance
 ...
 *     O-- FRONT --+
 */
//#define NOZZLE_TO_PROBE_OFFSET { 10, 10, 0 } //value defined elsewhere in cheetah 5

// Most probes should stay away from the edges of the bed, but
// with NOZZLE_AS_PROBE this can be negative for a wider probing area.
//#define PROBING_MARGIN 10 //value defined elsewhere in cheetah 5
...
//#define INVERT_E0_DIR false //value defined elsewhere.
...
// :[-1,1]
/* below line of codes until "asterisk slash have already been defined elsewhere"
#define X_HOME_DIR -1
#define Y_HOME_DIR -1
#define Z_HOME_DIR -1
...
//#define FILAMENT_RUNOUT_SENSOR
 ...
 #define FIL_RUNOUT_ENABLED_DEFAULT true // Enable the sensor on startup. Override with M412 followed by M500.
  ...
  #if ENABLED(INVERT_FS_LOGIC) // Previous code: FIL_RUNOUT_INVERTING replaced by FIL_RUNOUT_STATE
  #define FIL_RUNOUT_STATE HIGH // Trigger's alternative as soon as invert filamentsensor logic is activated
  #else
  #define FIL_RUNOUT_STATE LOW // Logic inverting is automatically taken care in section 13
  #endif
...
//#define DEBUG_LEVELING_FEATURE
  ...
  //#define GRID_MAX_POINTS_X 3 //grind values are defined elsewhere in cheetah 5.0
  //#define GRID_MAX_POINTS_Y GRID_MAX_POINTS_X //grind values are defined elsewhere in cheetah 5.0
...
#if ENABLED(Auto_bed_level)
#define HOMING_FEEDRATE_Z  (70*60) //changed from (8*60) to deliberately boost speeds. maybe the slower it is the more the sensor fluctuates. 
#else
