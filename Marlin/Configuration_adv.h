...
#if defined(BTTSKRE3MINIV2_0) || defined(BTTE3_TURBO)
 ...
 * in X2. Dual endstop offsets can be set at runtime with 'M666 X<offset> Y<offset> Z<offset>'.Z_STEPPER_AUTO_ALIGN
 */
...
//#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_UNLOAD_LENGTH      Total_filament_path  // User input for Cheetah 5.0 in config.h (mm) The length of filament for a complete unload.                                                  //   For Bowden, the full length of the tube and nozzle.
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_LENGTH    Total_filament_path  // User input for Cheetah 5.0 in config.h (mm) Load length of filament, from extruder gear to nozzle.                                                  //   For Bowden, the full length of the tube and nozzle.
                                                  //   For direct drive, the full length of the nozzle.
 ...
 */
   ...
   */
  //#define CHOPPER_TIMING CHOPPER_DEFAULT_12V chopper timing defined in custom printer profiles in cheetah 5
  ...
  //#define SENSORLESS_HOMING // StallGuard capable drivers only
    ...
    #define X_STALL_SENSITIVITY  8 // Please attempt to tune x stall sensititivy via host, M914 Xchang_value. Acceptable values -63 to 63
    #define X2_STALL_SENSITIVITY X_STALL_SENSITIVITY 
    #define Y_STALL_SENSITIVITY  8 // Please attempt to tune x stall sensititivy via host, M914 Ychang_value
    #define Y2_STALL_SENSITIVITY Y_STALL_SENSITIVITY
    #endif
...
#if ENABLED(Auto_bed_level)
   #define USER_DESC_2 "Repeatibility Test"
